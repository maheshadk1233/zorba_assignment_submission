...
//            //insert into patient table using preparedstatement
            ...
            //insert into hospitalbedinfo using preparedStatement
              ...
              PreparedStatement pstmtt = connection.prepareStatement(insertHospitalBedInfoQuery);
            pstmtt.setInt(1, bedinfo.getBedId());
            pstmtt.setString(2, bedinfo.getBedType());
            pstmtt.setInt(3, bedinfo.getBedChargeRate());
              pstmtt.setInt(4,bedinfo.getHospitalId());
            pstmtt.execute();
